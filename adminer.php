...
// Inject CSS via output buffer setelah adminer jalan
function adminer_object() {
    // Class Adminer sudah ada karena kita include core dengan cara khusus
    // Pakai plugin approach - wrap output
    return new Adminer();
}

// Load core - ini akan define class Adminer DAN langsung run
// Kita intercept outputnya untuk inject CSS
ob_start();
require $core;
$html = ob_get_clean();

// Inject CSS cyber neon sebelum </head>
$css = '<style>
@import url("https://fonts.googleapis.com/css2?family=Orbitron:wght@400;700;900&family=Share+Tech+Mono&display=swap");
:root{--c:#0ff;--p:#f0f;--g:#0f0;--bg:#020010;--ti:#e0e0ff;--td:#8888aa}
*{box-sizing:border-box}
body{background:var(--bg)!important;color:var(--ti)!important;font-family:"Share Tech Mono",monospace!important;min-height:100vh}
